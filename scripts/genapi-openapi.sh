...
orig=https://raw.githubusercontent.com/k8scommerce/k8scommerce/main/docs/swagger/v1/client.json
dest=$ROOT/../projects/client-gateway-sdk/src/lib/
...
#     -o $ROOT/../$dest \
#     --additional-properties=platform=browser,npmName=@k8scommerce/client-gateway-sdk,npmVersion=$version,providedIn=platform
...
# perl -pi -e 'BEGIN{undef $/;} s/client-gateway-sdk@(\d+)\.(\d+)\.(\d+)/client-gateway-sdk/smg' $ROOT/../README.md
